  ...
  return (
    <div key={reload} className="grid justify-center">
      ...
      <div>
        ...
        <label className="h-[150px] w-[150px] rounded-full block relative border-2 hover:border-amber-100" htmlFor="avatar">
          <img className="hover:scale-110 transition h-full w-full object-cover rounded-full"
